            ...
            <div class="owl-carousel owl-theme" id="brands-slider">
                ...
                <div class="text-center">
                    <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
                        <div class="brand_div d-flex align-items-center justify-content-center" style="height:98px">
                                ...
                                <div class="section-header">
                                    <div class="feature_header">
                                        <span class="for-feature-title">{{
                                            \App\CPU\translate('featured_products')}}</span>
                                    </div>
                                    <div>
                                        <a class="btn btn-outline-accent btn-sm viw-btn-a"
      ...
      -moz-box-shadow: 6px 8px 10px -10px rgba(0,0,0,0.25);">
                            <div class="container rtl">
                                <div class="section-header">
                                    <div class="feature_header">
                                        <span class="for-feature-title">{{
                                            \App\CPU\translate('latest_products')}}</span>
                                    </div>
                                    <div>
                                        <a class="btn btn-outline-accent btn-sm viw-btn-a"
