       ...
       <div class="widget h-100">
          ...
          @if($bestSell->product && $key<4) 
            <div class="col col-md-4 col-sm-2">
              <div class="media d-flex flex-column pt-2 pb-2 mb-1" data-href="{{route('product',$bestSell->product->slug)}}"
                style="height:195px">
               <div class="card-header" style="min-height: 127px; max-height: 135px; width: 100%;">
                    <a class="d-block text-center {{Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2' }}"
      ...
      @if($top->product && $key<4) <div class="col col-md-4 col-sm-2 mb-2">
        <div class="media d-flex flex-column pt-2 pb-2 mb-1" style="height:195px"
          data-href="{{route('product',$product->slug)}}">
            <div class="card-header" style="min-height: 127px; max-height: 135px; width: 100%;">
                 <a class="d-block text-center {{Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2' }}"
            href="{{route('product',$top->product->slug)}}" style="min-height: 127px; max-height: 135px">
            <img style="height: 100%; width: 100%; max-height: 120px; max-width: 95px"
              onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
