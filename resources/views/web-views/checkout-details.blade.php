                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="si-email">{{\App\CPU\translate('email_address')}}</label>
                                                <input class="form-control" type="email" name="email" id="si-email"
                                                    value="{{old('email')}}" placeholder="johndoe@example.com" required>
                                                <div class="invalid-feedback">{{\App\CPU\translate('Please provide a
                                                    valid email address')}}.
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="signup" role="tabpanel">
                                <form class="needs-validation_" autocomplete="off" novalidate id="sign-up-form"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="f_name" placeholder="John"
                                                    required>
                                                <div class="invalid-feedback">{{\App\CPU\translate('Please fill in your
                                                    name')}}.</div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="su-email">{{\App\CPU\translate('email_address')}}</label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="phone" type="number" id="su-phone"
                                                    placeholder="{{\App\CPU\translate('01700000000')}}" required>
                                                <div class="invalid-feedback">{{\App\CPU\translate('Please provide a
                                                    valid phone number')}}.
                                                </div>
                                            </div>
                ...
                <div class="col-6">
                    <a class="btn btn-secondary btn-block" href="{{route('shop-cart')}}">
                        <i class="czi-arrow-{{Session::get('direction') === " rtl" ? 'right' : 'left' }} mt-sm-0
                            mx-1"></i>
                        <span class="d-none d-sm-inline">{{\App\CPU\translate('Back')}} {{\App\CPU\translate('to')}}
                            {{\App\CPU\translate('Cart')}} </span>
