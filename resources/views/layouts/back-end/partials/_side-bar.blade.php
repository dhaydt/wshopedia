                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="nav-item {{Request::is('admin/business-settings/shipping-method/dhl')?'active':''}}">
                                    <a class="nav-link" href="{{route('admin.business-settings.shipping-method.dhl')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CPU\translate('Shipping_Module')}}
                                        </span>
                                    </a>
                                </li>
                                {{-- <li
