                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="city">{{\App\CPU\translate('City')}} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="city" value="{{ $shop->city }}" class="form-control"
                                        id="city" required>
                                </div>
                                <div class="form-group">
                                    <label for="country">{{\App\CPU\translate('Country')}} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="country" value="{{ $shop->country }}" class="form-control"
                                        id="country" required>
                                </div>
                            </div>
                            <div class="col-md-6">
