            ...
            <form action="{{route('seller.profile.update',[$data->id])}}" method="post" enctype="multipart/form-data"
                ...
                <div class="card mb-3 mb-lg-5" id="generalDiv">
                    ...
                    <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar"
                        ...
                        <img id="viewer" onerror="this.src='{{asset('public/assets/back-end/img/160x160/img1.jpg')}}'"
                            class="avatar-img" src="{{asset('storage/app/public/seller')}}/{{$data->image}}"
                            alt="Image">
                    </label>
                    <!-- End Avatar -->
                </div>
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <label for="city"
                                class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('City')}}</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="city" id="city" value="{{$data->city}}"
                                    placeholder="{{\App\CPU\translate('Enter your city')}}"
                                    aria-label="Enter your city">
                            </div>
                        </div>
                        <div class="row form-group">
                            <label for="country"
                                class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('Country')}}</label>

                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="country" id="country"
                                    value="{{$data->country}}"
                                    placeholder="{{\App\CPU\translate('Enter your country')}}"
