                            ...
                            <div class="row">
                                <div class="col-md-12" style="padding-top: 20px;">
                                    <label for="name">{{\App\CPU\translate('Upload')}}
                                        {{\App\CPU\translate('Image')}}</label><span class="badge badge-soft-danger">(
                                        {{\App\CPU\translate('ratio')}} 5:1 )</span>
                                ...
                                <div class="col-md-12">
                                    <center>
                                        <img style="width: auto;border: 1px solid; border-radius: 10px; max-height:200px;"
                                            id="viewer" src="{{asset('public\assets\back-end\img\1920x400\img2.jpg')}}"
                                            alt="banner image" />
                                    </center>
                                </div>
                            </div>
                ...
                <div class="card-header">
                    <div class="flex-between row justify-content-between align-items-center flex-grow-1 mx-1">
                        <div class="flex-between">
                            <div>
                                <h5>{{ \App\CPU\translate('flash_deal_table')}}</h5>
                            </div>
                            <div class="mx-1">
                                <h5 style="color: red;">({{ $flash_deal->total() }})</h5>
                            </div>
                        </div>
                        ...
                        <table id="datatable" style="text-align: {{Session::get('direction') === " rtl" ? 'right'
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" class="status" id="{{$deal['id']}}" {{$deal->status
                                            == 1?'checked':''}}>
